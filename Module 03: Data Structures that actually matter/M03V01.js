...
console.log("filter(x => x > 3):", numbers.filter(x => x > 3));
console.log("reduce((sum, x) => sum + x, 0):", numbers.reduce((sum, x) => sum + x, 0));
...
console.log("input.map(x => x * 2):", input.map(x => x * 2));
console.log("input.map(x => x * 2) again:", input.map(x => x * 2));
